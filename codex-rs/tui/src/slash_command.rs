...
impl SlashCommand {
    ...
    pub(crate) fn description_metadata(self) -> (&'static str, &'static str) {
        match self {
            SlashCommand::Tui => ("tui.slash-command.description.tui", "slash-tui-description"),
            SlashCommand::Daemon => (
                "tui.slash-command.description.daemon",
                "slash-daemon-description",
            ),
            SlashCommand::Warnings => (
                "tui.slash-command.description.warnings",
                "slash-warnings-description",
            ),
            ...
            SlashCommand::Recap => (
                "tui.slash-command.description.recap",
                "slash-recap-description",
            ),
            SlashCommand::Review => (
            ...
            SlashCommand::Worktree => (
                "tui.slash-command.description.worktree",
                "slash-worktree-description",
            ),
            ...
            SlashCommand::Voice => (
                "tui.slash-command.description.voice",
                "slash-voice-description",
            ),
            SlashCommand::Goal => (
            ...
            SlashCommand::MultiAgents => (
                "tui.slash-command.description.subagents",
                "slash-subagents-description",
            ),
            SlashCommand::Side | SlashCommand::Btw => (
