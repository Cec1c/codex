...
impl ChatWidget {
    ...
    fn usage_menu_params(&self) -> SelectionViewParams {
        ...
        SelectionViewParams {
            ...
            items: vec![
                SelectionItem {
                    name: usage_text("usage-show", "View analytics"),
                    description: Some(usage_text("usage-show-description", "Usage history")),
                ...
                SelectionItem {
                    name: usage_text("usage-redeem-reset", "Redeem reset"),
