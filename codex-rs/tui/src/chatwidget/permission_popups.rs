...
impl ChatWidget {
    ...
    pub(crate) fn open_auto_review_denials_popup(&mut self) {
        ...
        let mut items = vec![SelectionItem {
            name: permission_i18n::text("auto-review-action", "Action"),
        ...
        self.bottom_pane.show_selection_view(SelectionViewParams {
            header: Box::new(
                Paragraph::new(vec![
                    Line::from(
                        permission_i18n::text("auto-review-denials-title", "Auto-review Denials")
                            .bold(),
                    ),
                    Line::from(
                        permission_i18n::text(
