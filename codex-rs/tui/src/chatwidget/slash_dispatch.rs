            ...
            SlashCommand::Archive => {
                self.bottom_pane.show_selection_view(SelectionViewParams {
                    ...
                    subtitle: Some(slash_text(
                        "slash-archive-session-subtitle",
                    ...
                    items: vec![
                        ...
                        SelectionItem {
                            name: slash_text("slash-archive-session-confirm", "Yes, archive"),
                            description: Some(slash_text(
                                "slash-archive-now",
                    ...
                    items: vec![
                        ...
                        SelectionItem {
                            name: if self.remote_connection.is_some() {
                                "Yes, delete and return to command center".to_string()
                            } else {
                                slash_text("slash-delete-confirm", "Yes, delete and exit")
                            },
                            description: Some(slash_text(
                                "slash-delete-now",
